...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $widget['verified_influencers']          = Influencer::where('status', Status::INFLUENCER_ACTIVE)->where('ev', Status::VERIFIED)->where('sv',  Status::VERIFIED)->count();
        ...
        return view('admin.dashboard',compact('pageTitle', 'widget', 'chart', 'deposit', 'withdrawals','data'));
    }
