...
class GeneralSettingController extends Controller
{
    ...
    public function systemConfigurationSubmit(Request $request)
    {
        ...
        $general->influencer_kv   = $request->influencer_kv ? Status::ENABLE : Status::DISABLE;
        $general->service_approve = $request->service_approve ? Status::ENABLE : Status::DISABLE;
    ...
    public function pusher(){
        ...
        return view('admin.setting.pusher',compact('pageTitle'));
    }
