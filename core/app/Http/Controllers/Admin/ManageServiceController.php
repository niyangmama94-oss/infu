...
class ManageServiceController extends Controller {
    ...
    protected function serviceData($scope = null) {
        ...
        return $services->searchable(['title', 'influencer:username','category:name'])->with('influencer', 'category')->withCount('totalOrder', 'completeOrder')->orderBy('id', 'desc')->paginate(getPaginate());
    }
    ...
    public function status(Request $request, $id) {
        ...
        if ($request->status == Status::SERVICE_APPROVED) {
