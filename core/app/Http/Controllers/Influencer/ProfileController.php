...
class ProfileController extends Controller
{
    ...
    public function profile()
    {
        ...
        $data['total_services']   = Service::where('status', Status::SERVICE_APPROVED)->where('influencer_id', $influencer->id)->count();

        return view('Template::influencer.profile_setting', compact('pageTitle', 'categories', 'influencer', 'countries', 'data', 'languageData'));
    }
