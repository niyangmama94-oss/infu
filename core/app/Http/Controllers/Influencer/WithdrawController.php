...
class WithdrawController extends Controller
{
    ...
    public function withdrawLog(Request $request)
    {
        ...
        $withdraws = Withdrawal::searchable('trx')->where('influencer_id', authInfluencerId())->where('status', '!=', Status::PAYMENT_INITIATE)->with('method')->orderBy('id', 'desc')->paginate(getPaginate());
