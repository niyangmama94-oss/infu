...
{
    $pusherCredentials = gs('pusher_configuration');
    Config::set([
        'broadcasting.connections.pusher.key'             => $pusherCredentials->key,
        'broadcasting.connections.pusher.secret'          => $pusherCredentials->secret_key,
        'broadcasting.connections.pusher.app_id'          => $pusherCredentials->app_id,
        'broadcasting.connections.pusher.options.cluster' => $pusherCredentials->cluster,
    ]);
}
