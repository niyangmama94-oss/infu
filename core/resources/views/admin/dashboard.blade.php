    ...
    <div class="row gy-4 mt-2">
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                ...
                title="Email Unverified Influencers"
                icon="lar la-envelope"
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                ...
                title="Mobile Unverified Influencers"
                icon="las la-comment-slash"
        ...
        <div class="col-xxl-6">
            <div class="card box-shadow3 h-100">
                <div class="card-body">
                    ...
                    <div class="widget-card-wrapper">
                        <div class="widget-card bg--success">
                            <a href="{{ route('admin.withdraw.log') }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                        ...
                        <div class="widget-card bg--warning">
                            <a href="{{ route('admin.withdraw.pending') }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="fas fa-spinner"></i>
                                </div>
                        ...
                        <div class="widget-card bg--danger">
                            <a href="{{ route('admin.withdraw.rejected') }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
