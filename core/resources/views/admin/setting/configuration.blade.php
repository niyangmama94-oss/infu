                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="mb-0">
                                    <small>@lang('If you enable') <span class="fw-bold">@lang('KYC (Know Your Client)')</span> @lang('module, influencers must have to submit') <a href="{{ route('admin.influencer.kyc.setting') }}">@lang('the required data')</a>. @lang('Otherwise, influencers can\'t access on main functionalities of this system like crating services, taking jobs or orders, and communicating with clients.')</small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="influencer_kv" @if (gs("influencer_kv")) checked @endif>
                            </div>
                        </li>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <div class="form-group">
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="service_approve" @if (gs("service_approve")) checked @endif>
                            </div>
                        </li>
