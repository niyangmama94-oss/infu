                            ...
                            @forelse($items as $item)
                                <tr>
                                    ...
                                    <td >
                                        ...
                                        <a href="{{ route('admin.influencers.detail', $item->influencer_id)}}"> {{@$item->influencer->fullname}}</a>
                                        @else
                                    ...
                                    <td>
                                        <a href="{{ route('admin.influencer.ticket.view', $item->id) }}" class="btn btn-sm btn-outline--primary ms-1">
