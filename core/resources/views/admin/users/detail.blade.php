        ...
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="7"
                        link="{{ route('admin.hiring.index') }}?search={{ $user->username }}"
                        title="Total Hired"
                        icon="las la-users"
                        value="{{ $totalHired }}"
                        bg="17"
...
@push('breadcrumb-plugins')
    <a href="{{route('admin.users.login',$user->id)}}" target="_blank" class="btn btn-sm btn-outline--primary" ><i class="las la-sign-in-alt"></i>@lang('Login as Client')</a>
@endpush
