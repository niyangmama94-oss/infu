                ...
                <div class="row gy-5">
                    ...
                    <div class="col-lg-6">
                        <div class="account-content">
                            ...
                            <form method="POST" action="{{ route('influencer.login') }}" class="account-form verify-gcaptcha">
                                @csrf
                                ...
                                <div class="d-flex justify-content-between flex-wrap">
                                    <div class="form-group">
                                        <div class="form--check">
                                            <input class="form-check-input" id="remember" type="checkbox" @checked(old('remember')) name="remember"  {{ old('remember') ? 'checked' : '' }} >
                                            <div class="form-check-label">
                                                <label class="form-check-label" for="remember"> @lang('Remember Me')</label>
                                            </div>
                                        </div>
                                    </div>
                                    <a class="text--base forgot-url" href="{{ route('influencer.password.request') }}">@lang('Forgot Password?')</a>
                                </div>
                            ...
                            <div class="text-center">
                                <p class="mt-4">@lang('Don\'t have an account?')
                                    <a href="{{ route('influencer.register') }}" class="text--base register-url storageClear">@lang('Create an account')</a>
                                </p>
                            </div>
                        </div>
                    </div>
