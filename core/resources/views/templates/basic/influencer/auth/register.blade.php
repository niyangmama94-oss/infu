                ...
                <div class="row gy-5 align-items-center">
                    <div class="col-lg-6">
                        <div class="account-thumb-wrapper">
                            <img class="mw-100 h-100"
                                src="{{ getImage('assets/images/frontend/influencer_register/' . @$register->data_values->image, '660x450') }}">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="account-content">
                            <div class="d-flex justify-content-between flex-wrap gap-3 pb-5">
                                ...
                                <div class="account-content-right">
                                    <button class="btn btn--md btn--outline-base actionBtn" data-influencer="true"
                                        data-type="client" type="button">@lang('Client')</button>
                                    <button class="btn btn--md btn--outline-base actionBtn active" data-influencer="false"
                                        data-type="influencer" type="button">@lang('Influencer')</button>
                                </div>
                            </div>
                            <form class="form verify-gcaptcha" action="{{ route('influencer.register') }}" method="POST">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form--control checkUser" id="email"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form--control" id="password_confirm"
                            ...
                            <div class="text-center">
                                <p class="mt-3">@lang('Have an account? ')
                                    <a class="text--base login-url"
                                        href="{{ route('influencer.login') }}">@lang('Login here')</a>
                                </p>
                            </div>
                        </div>
                    </div>
...
@endif
    ...
    <div class="modal fade" id="existUserModalCenter" role="dialog" aria-labelledby="existModalCenterTitle"
            ...
            $('.checkUser').on('focusout', function(e) {
                ...
                $.post(url, data, function(response) {
                    ...
                    if (response.data != false && response.type == 'email') {
                        if (userType == 'influencer' || !isInfluencerActive) {
                            $('#existModalCenter').modal('show');
                        }
                        if (userType == 'client') {
                            $('#existUserModalCenter').modal('show');
                        }
