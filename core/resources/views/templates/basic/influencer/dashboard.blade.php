...
<div class="row justify-content-center gy-4">
    ...
    <div class="col-xxl-4 col-md-6 col-sm-10">
        <div class="dashboard-widget widget--primary">
            ...
            <div class="dashboard-widget__content">
                <a href="{{ route('influencer.withdraw.history') }}"><p>@lang('Total Withdrawn')</p></a>
                <h4 class="title">{{ showAmount($data['withdraw_balance']) }}</h4>
            </div>
        </div>
    </div>
    <div class="col-xxl-4 col-md-6 col-sm-10">
        <div class="dashboard-widget widget--secondary">
            ...
            <div class="dashboard-widget__content">
                <a href="{{ route('influencer.transactions') }}"><p>@lang('Total Transaction')</p></a>
    ...
    <div class="col-xxl-4 col-md-6 col-sm-10">
        <div class="dashboard-widget widget--info">
            ...
            <div class="dashboard-widget__content">
              <a href="{{ route('influencer.hiring.index') }}"><p>@lang('Total Hiring')</p></a>
    ...
    <div class="col-xxl-4 col-md-6 col-sm-10">
        <div class="dashboard-widget widget--purple">
            ...
            <div class="dashboard-widget__content">
               <a href="{{ route('influencer.service.order.index') }}"><p>@lang('Total Order')</p></a>
    ...
    <div class="col-xxl-4 col-md-6 col-sm-10">
        <div class="dashboard-widget widget--warning">
            ...
            <div class="dashboard-widget__content">
               <a href="{{ route('influencer.service.all') }}"><p>@lang('Total Service')</p></a>
