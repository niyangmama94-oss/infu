                                ...
                                <div class="chat__msg" id="coversation_body">
                                    ...
                                    @if (!($hiring->status == 1 || $hiring->status == 5 || $hiring->status == 6))
                                        <div class="chat__msg-footer">
                                            ...
                                            <form action="" method="POST" class="send__msg"
...
@push('script')
    <script>
        (function($) {
            ...
            const channnelName = `chat-data-conversion-{{ $hiring->id }}`;
            ...
            function loadMore(messageCount) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('influencer.hiring.conversation.message') }}",
            ...
            $("#messageForm").submit(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('influencer.hiring.conversation.store', @$hiring->id) }}",
                    method: "POST",
                    data: formData,
                    async: false,
                    processData: false,
