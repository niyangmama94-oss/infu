...
@section('content')
    <div class="card custom--card">
        <div class="card-header d-flex align-items-center justify-content-between flex-wrap">
            ...
            <a href="{{ route('influencer.ticket') }}" class="btn btn--outline-custom btn--sm">@lang('My Tickets')</a>
        </div>
        <div class="card-body">
            <form class="row gy-3" action="{{ route('influencer.ticket.store') }}" method="post" enctype="multipart/form-data"
                ...
                <div class="form--group col-md-12">
                    ...
                    <select name="priority" class="form-control form--control form-select select2" required>
