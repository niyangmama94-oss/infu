                ...
                <div class="col-xl-3">
                    <div class="d-flex justify-content-between dash-sidebar filter-sidebar p-xl-0 flex-wrap gap-4 shadow-none">
                            ...
                            <div class="sidebar-widget">
                                ...
                                <div class="checkbox-wrapper">
                                    <div class="custom--checkbox">
                                        <input class="form-check-input cursor-pointer sortCategory" type="checkbox" name="category" value="" id="category0" checked>
                                        <label class="form-check-label cursor-pointer" for="category0">@lang('All Categories')</label>
                                    </div>
                                    @foreach ($allCategory as $category)
                                        <div class="custom--checkbox my-2">
                                            <input class="form-check-input cursor-pointer sortCategory" type="checkbox" name="category" value="{{ $category->id }}" id="category{{ $category->id }}">
                                            <label class="form-check-label cursor-pointer" for="category{{ $category->id }}">{{ __($category->name) }}</label>
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div class="sidebar-widget has-select2 position-relative">
                            ...
                            <select class="form-control form--control country form-select select2" name="country">
                            ...
                            <div class="action-widget__body" style="">
                                ...
                                <div class="form-check custom--radio d-flex justify-content-between align-items-center">
                                    <div class="left">
                                        ...
                                        <label class="form-check-label cursor-pointer" for="ratings-0">@lang('All') </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-check custom--radio d-flex justify-content-between align-items-center">
                                    <div class="left">
                                        ...
                                        <label class="form-check-label cursor-pointer" for="ratings-4">
                                ...
                                <div class="form-check custom--radio d-flex justify-content-between align-items-center">
                                    <div class="left">
                                        ...
                                        <label class="form-check-label cursor-pointer" for="ratings-3">
                                            <span class="text--warning">
                                ...
                                <div class="form-check custom--radio d-flex justify-content-between align-items-center">
                                    <div class="left">
                                        ...
                                        <label class="form-check-label cursor-pointer" for="ratings-2">
                                            <span class="text--warning">
                                                <i class="las la-star"></i>
                                                <i class="las la-star"></i>
                                                <i class="la la-star-o"></i>
                                ...
                                <div class="form-check custom--radio d-flex justify-content-between align-items-center">
                                    <div class="left">
                                        ...
                                        <label class="form-check-label cursor-pointer" for="ratings-1">
                                            <span class="text--warning">
                                                <i class="las la-star"></i>
                                                <i class="la la-star-o"></i>
                                                <i class="la la-star-o"></i>
                        ...
                        <div class="sidebar-widget">
                            ...
                            <div class="radio-wrapper">
                                <div class="custom--radio my-2">
                                    ...
                                    <label class="form-check-label cursor-pointer" for="latest">
                                        @lang('Latest')
                                    </label>
                                </div>
                                <div class="custom--radio my-2">
                                    <input class="form-check-input sortInfluencer" type="radio" value="top_rated" name="sort" id="top_rated">
                                    <label class="form-check-label cursor-pointer" for="top_rated">
                                        @lang('Top Rated')
                                    </label>
                                </div>
                            </div>
