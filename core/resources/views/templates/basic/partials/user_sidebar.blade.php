    ...
    <div class="dash-sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ menuActive('user.order*',2) }}">
                <a href="javascript:void(0)"><i class="las la-list"></i> @lang('Orders')</a>

                <ul class="sidebar-submenu  }}">
                    <li><a href="{{ route('user.order.all') }}" class="{{ menuActive('user.order.all') }}"><i class="las la-dot-circle"></i> @lang('All Orders')</a></li>
                    <li><a href="{{ route('user.order.complete') }}" class="{{ menuActive('user.order.complete') }}"><i class="las la-dot-circle"></i> @lang('Complete Orders')</a></li>
                    <li><a href="{{ route('user.order.incomplete') }}" class="{{ menuActive('user.order.incomplete') }}"><i class="las la-dot-circle"></i> @lang('Incomplete Orders')</a></li>
                </ul>
            </li>
