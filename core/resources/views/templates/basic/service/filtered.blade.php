        ...
        <div class="service-item">
            ...
            <div class="service-item__content">
                <div class="influencer-thumb">
                    <img src="{{ getImage(getFilePath('influencerProfile') . '/' .@$service->influencer->image, avatar:true) }}" alt="images">
                </div>
                ...
                <div class="service-footer border-top pt-1 d-flex flex-wrap justify-content-between align-items-center">
                    ...
                    <h6 class="service-price fs--15px">{{ showAmount($service->price) }}</h6>
                </div>
            </div>
        </div>
    </div>
@empty
    <div class="col-md-6 col-lg-8">
        <img class="w-100" src="{{ getImage('assets/images/frontend/empty_message/' . @$emptyMsgImage->data_values->image, '800x600') }}" alt="">
    </div>
@endforelse
