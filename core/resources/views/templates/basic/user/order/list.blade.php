...
<table class="table--responsive--lg table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <span class="fw-bold"><a href="{{ route('influencer.profile', [slug($order->influencer->username), $order->influencer_id]) }}" class="text--base">{{ __(@$order->influencer->username) }}</a></span>
            </td>
