                            ...
                            <div class="row gy-3">
                                    ...
                                    <div class="d-flex flex-md-wrap-reverse flex-wrap gap-2">
                                        <div class="form-group order-1">
                                            ...
                                            <div class="profile-thumb text-center">
                                                ...
                                                <div class="thumb">
                                                    <img id="upload-img" src="{{ getImage(getFilePath('userProfile') . '/' . $user->image,avatar:true) }}" alt="userProfile">
                                ...
                                <div class="col-xxl-8 col-md-7">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form--control" id="state" name="state" placeholder="@lang('State')" value="{{ @$user->state }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="zip" class="col-form-label">@lang('Zip Code')</label>
                                        <input type="text" class="form-control form--control" id="zip" name="zip" placeholder="@lang('Zip Code')" value="{{ @$user->zip }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="city" class="col-form-label">@lang('City')</label>
                                        <input type="text" class="form-control form--control" id="city" name="city" placeholder="@lang('City')" value="{{ @$user->city }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="address" class="col-form-label">@lang('Address')</label>
                                        <input type="text" class="form-control form--control" id="address" name="address" placeholder="@lang('Address')" value="{{ @$user->address }}">
                                    </div>
                                </div>
                            </div>
