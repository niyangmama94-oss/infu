            ...
            <form action="">
                <div class="d-flex flex-wrap gap-4">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <select class="form-control form--control form-select select2" name="trx_type">
                    ...
                    <div class="flex-grow-1 align-self-center">
                        <button class="form--control btn btn--base w-100 text-light"><i class="las la-filter"></i> @lang('Filter')</button>
                    </div>
                </div>
            </form>
        </div>
